    ...
    <div className="flex flex-col font-[Montserrat] gap-6 md:gap-8 w-full">
      ...
      <div className="relative w-full bg-gradient-to-br from-white via-gray-50 to-white border border-gray-100 rounded-xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 group overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center gap-6">
          ...
          {/* Subtle stats/illustration */}
          {/* <div className="flex gap-6 pt-4 opacity-60">
            <div className="flex flex-col items-center gap-1 text-xs">
              <span className="w-8 h-8 bg-gradient-to-br from-green-400 to-green-500 rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-lg">
                0
              </span>
              <span className="text-gray-400 font-medium">Shipments</span>
            </div>
            <div className="flex flex-col items-center gap-1 text-xs">
              <span className="w-8 h-8 bg-gradient-to-br from-blue-400 to-blue-500 rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-lg">
                0
              </span>
              <span className="text-gray-400 font-medium">Drivers</span>
            </div>
          </div> */}
        </div>
      </div>
