...
const ShipmentMap = ({ shipments = [], pagination = {}, onPageChange }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 w-full">
      {/* ==================== MAP SECTION ==================== */}
      <div className="order-1 lg:order-2 w-full lg:w-[65%] flex flex-col gap-4">
        {/* Map Header */}
        ...
        {/* Map Container */}
        <div className="relative w-full h-[260px] sm:h-[320px] md:h-[380px] lg:h-[400px] rounded-xl overflow-hidden border-4 border-[#BF9B53] shadow-[inset_0_4px_10px_rgba(0,0,0,0.25)] transition-shadow">
          ...
          {selectedShipment?.estimatedDistance && showEstimate && (
            <div className="absolute top-4 left-1/2 -translate-x-1/2 z-[10] animate-fadeInDown">
              <div className="bg-gradient-to-r from-[#BF9B53] to-[#9d7d42] text-white px-6 py-3 rounded-lg shadow-lg font-semibold flex items-center gap-2 text-sm md:text-base">
                ...
                <span className="text-xs opacity-75">(Estimated Distance)</span>
              </div>
            </div>
          )}
      ...
      {/* ==================== LIST SECTION ==================== */}
      <div className="order-2 lg:order-1 flex-1 bg-white rounded-xl shadow-lg border border-gray-200 flex flex-col overflow-hidden max-h-[456px]">
        {/* List Header */}
