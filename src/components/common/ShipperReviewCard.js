...
const ShipperReviewCard = ({ shipper }) => {
  ...
  // Generate stars based on rating (full + half + empty)
  ...
  return (
    ...
    >
      ...
      {/* Review Text */}
      <div className="mt-2 text-sm sm:text-base text-gray-700 font-montserrat">
        {shipper.reviewText || "No review provided"}
      </div>

      {/* Region */}
      <div className="flex items-center gap-1 mt-2 text-xs sm:text-sm text-gray-600">
        <IoLocationOutline
          size={16}
          className="text-gray-500"
          style={{ width: "21.33px", height: "21.33px" }}
        />
